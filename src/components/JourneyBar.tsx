...
export default function JourneyBar({activeTab, onNavigate, agentCount, hasPublishedRelease, enabledInstallationCount, hasCorrelation}: JourneyBarProps) {
  const steps = [
    ...
    {id: 'ledger', label: 'Trace', detail: hasCorrelation ? 'Correlation ready' : 'Inspect results', icon: BookOpen, complete: false},
  ] as const;
